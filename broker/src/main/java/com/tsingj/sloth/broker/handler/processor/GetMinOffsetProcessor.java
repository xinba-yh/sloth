...
@Slf4j
@Component
public class GetMinOffsetProcessor implements RemoteRequestProcessor {

    private final StorageEngine storageEngine;

    public GetMinOffsetProcessor(StorageEngine storageEngine) {
        this.storageEngine = storageEngine;
    }

    @Override
    public byte getCommand() {
        return ProtocolConstants.Command.GET_MIN_OFFSET;
    }
